...
- 👨‍💻 I enjoy contributing to **Open Source Projects** and am really enthusiastic about learning new technology. From 2020 I was learning the Data Science entered into a vast world where I get dusty with data. In 2020 **R Programming Language** continued to **Python**. In 2021 till now I learned **Machine Learning** , **Tableau** & a bit about **SQL**,**HTML**,**CSS**,**JavaScrpit**,**PowerBI**,**Big_Data_Hadoop & Spark_Developer**,**Flask API and Deploying a Machine learning model**, **NLP**, **Computer Vision**.
- Recent Intrests **Cloud** & **Devops**. :star: From [Cloud](https://github.com/Journey-to-Cloud)
